...
OBJ_FILES=main.cpp.o hacks/player_info.cpp.o hacks/draw.cpp.o hacks/create_move.cpp.o hacks/esp.cpp.o hacks/aimbot.cpp.o gui/gui.cpp.o hacks/crosshair.cpp.o
